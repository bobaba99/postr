# Authentication — export pack — UIMax full review

- Audited URL: `http://127.0.0.1:4174/auth?plan=pack`
...
**URL:** http://127.0.0.1:4174/auth?plan=pack
**Code Directory:** /Users/zihaogeng/development/postr-ux-audit-flow-map/apps/web/src
**Generated:** 2026-07-30T03:41:09.511Z
...
**URL:** http://127.0.0.1:4174/auth?plan=pack
**Scanned:** 2026-07-30T03:41:01.227Z
**Violations:** 0
**Passes:** 32
**Incomplete:** 0
...
## Performance Metrics
**URL:** http://127.0.0.1:4174/auth?plan=pack
**Measured:** 2026-07-30T03:41:03.530Z
### Core Web Vitals
| Metric | Value | Rating |
|--------|-------|--------|
...
**Measured:** 2026-07-30T03:41:01.463Z
...
| FAIL | Reduce unused JavaScript — Est savings of 298 KiB |
...
- Page Title (Sign in or create an account | Postr)
- Meta Description (Sign in to Postr, create an account, or continue as a guest to build, save, and export conference posters securely from your browser.)
- Single H1 Tag (1 H1 tag(s))
- Heading Hierarchy (1 headings (proper hierarchy))
- Canonical URL (https://www.postr.sh/auth)
- HTML Lang Attribute (en)
- Viewport Meta Tag (width=device-width, initial-scale=1.0)
- Image Alt Text (No images found)
- Open Graph Title (Sign in or create an account | Postr)
- Open Graph Description (Sign in to Postr, create an account, or continue as a guest to build, save, and export conference posters securely from your browser.)
...
- Title Length (36 characters)
- Description Length (133 characters)
