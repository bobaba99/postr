# Not found — UIMax full review

- Audited URL: `http://127.0.0.1:4174/this-route-does-not-exist`
...
**URL:** http://127.0.0.1:4174/this-route-does-not-exist
**Code Directory:** /Users/zihaogeng/development/postr-ux-audit-flow-map/apps/web/src
**Timestamp:** 2026-07-30T03:41:54.540Z
**Accessibility violations:** 0
**Accessibility passes:** 17
**Load time:** 76ms
**DOM nodes:** 41
...
**URL:** http://127.0.0.1:4174/this-route-does-not-exist
**Code Directory:** /Users/zihaogeng/development/postr-ux-audit-flow-map/apps/web/src
**Generated:** 2026-07-30T03:41:54.540Z
...
**URL:** http://127.0.0.1:4174/this-route-does-not-exist
**Scanned:** 2026-07-30T03:41:45.763Z
**Violations:** 0
**Passes:** 17
**Incomplete:** 0
...
## Performance Metrics
**URL:** http://127.0.0.1:4174/this-route-does-not-exist
**Measured:** 2026-07-30T03:41:48.036Z
### Core Web Vitals
| Metric | Value | Rating |
|--------|-------|--------|
| First Contentful Paint (FCP) | 600ms (Good) |
| Largest Contentful Paint (LCP) | 600ms (Good) |
...
**Measured:** 2026-07-30T03:41:46.569Z
...
| FAIL | Reduce unused JavaScript — Est savings of 302 KiB |
...
- **Description Length**: Description is too short (25 chars). Aim for 120-160 characters for optimal search display.
  Current: 25 characters

### Passing Checks

- Page Title (Page not found | Postr)
- Meta Description (That page does not exist.)
- Single H1 Tag (1 H1 tag(s))
- Heading Hierarchy (1 headings (proper hierarchy))
- Canonical URL (https://www.postr.sh/404)
- HTML Lang Attribute (en)
- Viewport Meta Tag (width=device-width, initial-scale=1.0)
- Image Alt Text (No images found)
- Open Graph Title (Page not found | Postr)
- Open Graph Description (That page does not exist.)
...
- Link Accessibility (0/1 links missing descriptive text)
