# Cookies — UIMax full review

- Audited URL: `http://127.0.0.1:4174/cookies`
...
**URL:** http://127.0.0.1:4174/cookies
**Code Directory:** /Users/zihaogeng/development/postr-ux-audit-flow-map/apps/web/src
**Timestamp:** 2026-07-30T03:40:10.638Z
**Accessibility violations:** 0
**Accessibility passes:** 29
**Load time:** 76ms
**DOM nodes:** 210
...
**Lighthouse SEO:** 100
**SEO Score:** 98/100 (17 passed, 1 failed)
...
**URL:** http://127.0.0.1:4174/cookies
**Code Directory:** /Users/zihaogeng/development/postr-ux-audit-flow-map/apps/web/src
**Generated:** 2026-07-30T03:40:10.638Z
...
**URL:** http://127.0.0.1:4174/cookies
**Scanned:** 2026-07-30T03:40:02.391Z
**Violations:** 0
**Passes:** 29
**Incomplete:** 0
...
## Performance Metrics
**URL:** http://127.0.0.1:4174/cookies
**Measured:** 2026-07-30T03:40:04.610Z
### Core Web Vitals
| Metric | Value | Rating |
|--------|-------|--------|
| First Contentful Paint (FCP) | 584ms (Good) |
| Largest Contentful Paint (LCP) | 584ms (Good) |
...
**Measured:** 2026-07-30T03:40:02.517Z
...
| FAIL | Reduce unused JavaScript — Est savings of 295 KiB |

### Passing Audits
| Status | Audit |
|--------|-------|
| PASS | First Contentful Paint — 1.5 s |
...
| PASS | Minimizes main-thread work — 0.6 s |
...
#### LOW
- **Title Length**: Title is too short (21 chars). Aim for 30-60 characters for optimal search display.
  Current: 21 characters

### Passing Checks

- Page Title (Cookie Policy | Postr)
- Meta Description (What Postr stores on your device and what it does not. Essential authentication only — page counting is cookieless, with no persistent identifier.)
- Single H1 Tag (1 H1 tag(s))
- Heading Hierarchy (14 headings (proper hierarchy))
- Canonical URL (https://www.postr.sh/cookies)
- HTML Lang Attribute (en)
- Viewport Meta Tag (width=device-width, initial-scale=1.0)
- Image Alt Text (No images found)
- Open Graph Title (Cookie Policy | Postr)
- Open Graph Description (What Postr stores on your device and what it does not. Essential authentication only — page counting is cookieless, with no persistent identifier.)
...
- Link Accessibility (0/26 links missing descriptive text)
...
UIMax also ran its repository-wide heuristic scan. That repeated output is omitted here because it is identical across route reports and is not page-specific; the audit summary preserves its scope and caveat.
