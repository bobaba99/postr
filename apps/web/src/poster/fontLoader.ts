/**
 * fontLoader — Google Fonts URLs + idempotent injection for the ten
 * curated families. Extracted from PosterEditor so the copy-a-design
 * preview (CopyDesignModal) can warm the candidate font without
 * importing the whole editor.
 *
 * Only the requested family is loaded (see the print-perf note in
 * the 2026-07 commit history: loading all ten at once was measurable).
 */
