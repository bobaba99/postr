...
// =========================================================================
// CropHint — pointer that the crop UI is now inline on the block
// =========================================================================
//
// Replaces the previous slider-based ImageCropEditor: cropping happens
// via the ✂︎ button on the block's top toolbar, which spawns a
// drag-handle overlay (CropOverlay.tsx). The hint stays in the
// sidebar so users who used to look here still know where to go.
  ...
  return (
    <div style={{ marginTop: 18 }}>
      ...
      <div style={{ fontSize: 12, color: '#6b7280', lineHeight: 1.5 }}>
        Click the ✂︎ button on the block's top toolbar to crop the image
