  ...
  const printPoster = useCallback(() => {
    ...
    printWin.document.write(
      buildPrintDocument({
        ...
        px: PX,
        fontFamily: doc.fontFamily,
        fontHref: googleFontsUrl(doc.fontFamily),
        bgColor: doc.palette.bg,
        title: (posterDisplayName || 'Poster').replace(/[<>]/g, ''),
        canvasHtml: clone.outerHTML,
        // Paid tier does not exist yet — the entitlement gets
        // threaded in here (and only here) when it ships.
        attribution: {},
      }),
    );
